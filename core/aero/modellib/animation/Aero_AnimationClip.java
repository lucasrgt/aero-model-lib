...
public final class Aero_AnimationClip {
    ...
    public boolean sampleRotInto(int boneIdx, float time, float[] out, int[] cursor) {
    ...
    public boolean samplePosInto(int boneIdx, float time, float[] out, int[] cursor) {
    ...
    public boolean sampleSclInto(int boneIdx, float time, float[] out, int[] cursor) {
    ...
    public boolean sampleUvOffsetInto(int boneIdx, float time, float[] out, int[] cursor) {
    ...
    public boolean sampleUvScaleInto(int boneIdx, float time, float[] out, int[] cursor) {
