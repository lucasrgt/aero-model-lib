...
public class Aero_AnimationBundle {
    ...
    public Aero_AnimationBundle(Map clips, Map pivots, Map childMap) {
        this(clips, pivots, childMap, java.util.Collections.EMPTY_MAP);
    }

    public Aero_AnimationBundle(Map clips, Map pivots, Map childMap, Map morphTargetPaths) {
    ...
    public float[] pivotOrZero(String boneName) {
        float[] p = (float[]) pivots.get(boneName);
