...
public final class Aero_AnimationPoseResolver {

    private static final float PIXEL_TO_BLOCK = 1f / 16f;

    private Aero_AnimationPoseResolver() {}

    public static void resolveClip(Aero_MeshModel.BoneRef ref,
    ...
    public static void resolveClip(int boneIdx,
                            String boneName,
                            float[] pivot,
                            Aero_AnimationClip clip,
                            Aero_AnimationPlayback playback,
    ...
    public static void resolveStack(Aero_AnimationStack stack,
                             String boneName,
                             float partialTick,
                             float[] scratchPivot,
                             float[] scratchRot,
